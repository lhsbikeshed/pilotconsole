...
public class Rot implements VectorConstants, Serializable {
  ...
  public final static float dotProduct(Rot a, Rot b) {
    return a.q1 * b.q1 + a.q2 * b.q2 + a.q3 * b.q3 + a.q0 * b.q0;
  }

  public static final Rot slerp(Rot a, Rot b, float t, boolean allowFlip) {
    ...
    if ((1.0f - PApplet.abs(cosAngle)) < 0.01f) {
      c1 = 1.0f - t;
      c2 = t;
    } 
    else {
    ...
    return new Rot(c1 * a.q0 + c2 * b.q0, c1 * a.q1 + c2 * b.q1, c1 * a.q2 + c2 * b.q2, c1 * a.q3
      + c2 * b.q3, false);
  }
}
